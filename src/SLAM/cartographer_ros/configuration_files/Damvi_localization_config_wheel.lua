...
options.damvi_runtime_options = {
  ...
  pose_graph_relocalization_max_translation_correction = 0.75,
  pose_graph_relocalization_max_yaw_correction = 0.8,
  pose_graph_recovery_constraint_weight_scale = 0.35,

  -- pose_graph_relocalization_prior_min_score = 0.35,
  -- pose_graph_relocalization_max_translation_correction = 0.7,
  -- pose_graph_relocalization_max_yaw_correction = 0.8,
  -- pose_graph_recovery_constraint_weight_scale = 0.35,
  ...
  adaptive_odometry_max_weight =
      wheel_config_or_default("adaptive_odometry_max_weight", 1.0),
  adaptive_odometry_mismatch_override =
      wheel_config_bool_or_default("adaptive_odometry_mismatch_override", true),
  ...
  adaptive_odometry_mismatch_force_weight =
      wheel_config_or_default("adaptive_odometry_mismatch_force_weight", 1.0),
...
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher.angular_search_window = math.rad(18.0)
