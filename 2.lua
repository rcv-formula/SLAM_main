-- Rank 2
-- Mode: FULL_PIPELINE
-- Source: retune_full_wider_search_center (2 repeated runs)
-- Summary:
--   mean_accepted_ratio = 0.0828583839
--   worst_longest_no_candidate_streak = 66
--   worst_no_candidate_ratio = 0.3313562673
--   worst_min_best_score = 0.1664
--   worst_p05_best_score = 0.346750
-- Notes:
--   Wider frozen search window without center-weighted scoring.
