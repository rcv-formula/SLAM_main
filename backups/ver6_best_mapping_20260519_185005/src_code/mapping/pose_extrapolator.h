...
class PoseExtrapolator : public PoseExtrapolatorInterface {
 public:
  ...
  void SetFeaturelessStraightMode(bool enabled, double degeneracy_ratio);
...
//curve line: R_scan = 5.0e-7, R_odom = 1.0e-3
  ...
  double featureless_wheelodom_weight = 0.08;
  double featureless_max_scan_to_odom_ratio = 1.8;
  double featureless_imu_weight = 0.6;
  bool featureless_straight_mode = false;
  double featureless_degeneracy_ratio = 0.0;
