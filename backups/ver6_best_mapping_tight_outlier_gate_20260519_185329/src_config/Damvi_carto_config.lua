...
TRAJECTORY_BUILDER_2D.outlier_max_translation_residual = 0.075
TRAJECTORY_BUILDER_2D.outlier_max_rotation_residual = 0.015
TRAJECTORY_BUILDER_2D.outlier_min_num_filtered_points = 0
TRAJECTORY_BUILDER_2D.outlier_required_failures = 1
TRAJECTORY_BUILDER_2D.outlier_medium_translation_residual = 0.045
TRAJECTORY_BUILDER_2D.outlier_medium_rotation_residual = 0.009
