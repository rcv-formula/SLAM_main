...
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher.linear_search_window = 0.20
...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.occupied_space_weight =
    wheel_config_or_default("ceres_occupied_space_weight", 15.0)
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.translation_weight =
    wheel_config_or_default("ceres_translation_weight", 30.0)
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.rotation_weight =
    wheel_config_or_default("ceres_rotation_weight", 30.0)
