...
mkdir -p \
  ...
  "$PRIMARY_INSTALL_CARTO/pbstream" "$MIRROR_INSTALL_CARTO/pbstream"
...
cp "$PRIMARY_CARTO/pbstream/latest.pbstream" "$MIRROR_CARTO/pbstream/latest.pbstream"
cp "$PRIMARY_CARTO/pbstream/latest.pbstream" "$PRIMARY_INSTALL_CARTO/pbstream/latest.pbstream"
cp "$PRIMARY_CARTO/pbstream/latest.pbstream" "$MIRROR_INSTALL_CARTO/pbstream/latest.pbstream"
cp "$PRIMARY_CARTO/maps/latest.pgm" "$MIRROR_CARTO/maps/latest.pgm"
cp "$PRIMARY_CARTO/maps/latest.yaml" "$MIRROR_CARTO/maps/latest.yaml"
